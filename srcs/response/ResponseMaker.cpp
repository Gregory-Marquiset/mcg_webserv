...
void	ResponseMaker::createGetResponse(void)
{
	...
	else
	{
		...
		if (this->_req_infos.getCgi() == true)
		{
			...
			cgi_return = we_checkCGI(this->_req_infos.getCgiPath(), this->_req_infos.getFinalPath(), this->_req_infos.getCookie(), this->_req_infos.getBody(), this->_error_class);
